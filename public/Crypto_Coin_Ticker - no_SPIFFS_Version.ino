...
// For M5-Stack MCU , coded in ArduinoIDE 1.8.13 - last modified Mar.19.2023 22:44 CET - Version 1.0.54  - THIS VERSION USES SD-CARD DATA FOLDER instead of SFIFFS + SDconfig (intended for SD-MenuLoader)
//
//
//

...
String pair_name[]    = {"Bitcoin",    "ETH",         "BNB",        "IOTA",        "LINK",         "DOT",           "YearnFI",   "DOGE"            }; //name for TopPanel (6-8 letters)
String pair_STRING[]  = {"BTCUSDT",    "ETHUSDT",     "BNBUSDT",    "IOTAUSDT",    "LINKUSDT",     "DOTUSDT",       "YFIUSDT",   "DOGEUSDT"        }; //name for url in BIG LETTERS
String pair_string[]  = {"btcusdt",    "ethusdt",     "bnbusdt",    "iotausdt",    "linkusdt",     "dotusdt",       "yfiusdt",   "dogeusdt"        }; //name for url in small letters
uint32_t pair_color[] = {TFT_YELLOW,   TFT_DARKCYAN,  TFT_ORANGE,   TFT_LIGHTGREY, TFT_CYAN,       TFT_PINK,        TFT_BLUE,    TFT_MAROON        }; //color in uint32_t format
